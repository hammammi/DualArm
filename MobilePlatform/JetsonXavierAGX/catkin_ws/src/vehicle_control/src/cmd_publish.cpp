...
int main(int argc, char **argv)
{
  ...
  ros::Rate loop_rate(10); // Setting 50 Hz //
  ...
  while(ros::ok())
  {
    ...
    // Trajectory : Circle
      ...
      xd[i] = 0.5 * cos( (double) 2.0*3.141592/N*i);
		///(1+sin( (double) 2.0*3.141592/N*i)*sin( (double) 2.0*3.141592/N*i));
      yd[i] = 0.5 * sin( (double) 2.0*3.141592/N*i); //*cos( (double) 2.0*3.141592/N*i)
		///(1+sin( (double) 2.0*3.141592/N*i)*sin( (double) 2.0*3.141592/N*i));
    ...
    xd[i] = 0;
    yd[i] = 0;
    phid[i] = (double) (index-1)*2*3.141592;
    index = 4;
    N=0;
    }
