...
{
    ros::init(argc, argv, "controller_pdo_pican");
    ros::NodeHandle n;
    string rtr;
...
//        ros::Time begin = ros::Time::now();
        ...
        frame.can_id  = COB_ID_Tx[0][1] | CAN_RTR_FLAG;
        write(s, &frame, sizeof(struct can_frame));
